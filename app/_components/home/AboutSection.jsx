            ...
            <div className="container-fluid max-w-7xl mx-auto px-4 sm:px-6 xl:px-0">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10 items-center py-12 md:py-16">
                    ...
                    <div className="space-y-6">
                        <h1 className="md:text-[36px] font-semibold text-center md:text-left text-[28px]">
                            About Us
                        </h1>

                        <p className="text-center md:text-left md:leading-7 text-[16px] leading-6">
                        ...
                        <h1 className="md:text-[36px] font-semibold text-center md:text-left mt-6 text-[28px]">
                            Our Vision
                        </h1>
