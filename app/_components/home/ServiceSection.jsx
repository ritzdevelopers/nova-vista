                ...
                >
                    ...
                    >
                        ...
                        <p className="md:text-[26px] text-[18px] leading-8 font-semibold">
                            ...
                            <br />
                            <span className="mt-3 inline-block text-center w-full  lg:w-[600px]">
            ...
            <div className="max-w-7xl mx-auto px-0 md:px-0 xl:px-0 mt-6">
                ...
                w-[265px] md:w-auto mx-auto"
                            >
                                ...
                                <br className="hidden md:block" /> achievers and
                                eminent persons
                            </div>
                        </motion.div>
                    </div>
                ...
                h-[200px] sm:h-auto shadow-lg"
                  ...
                  text-white px-4 sm:px-6 py-5 font-semibold"
                                custom="left"
                                variants={textVariants}
                                initial={reduceMotion ? false : "hidden"}
                                whileInView={reduceMotion ? undefined : "show"}
                                ...
                                transition={{ duration: 0.6, ease: "easeOut" }}
                            >
                                Establishment Of Schools/Colleges/ <br />
